...
describe('_.is.float()', function () {
    it('Should return true for float', function () {
        expect(_.is.float(42.42)).to.equal(true);
    });

    it('Should return false for other numbers', function () {
        expect(_.is.float(42)).to.equal(false);
        expect(_.is.float(0)).to.equal(false);
    });
});

describe('_.is.int()', function () {
    it('Should return true for integer', function () {
        expect(_.is.int(42)).to.equal(true);
    });

    it('Should return true for zero', function () {
        expect(_.is.int(0)).to.equal(true);
    });

    it('Should return false for float', function () {
        expect(_.is.int(42.42)).to.equal(false);
    });
});

describe('_.is.primitive()', function () {
    it('Boolean should be primitive', function () {
        expect(_.is.primitive(true)).to.equal(true);
        expect(_.is.primitive(false)).to.equal(true);
        expect(_.is.primitive(new Boolean(false))).to.equal(true);
        expect(_.is.primitive(Boolean(true))).to.equal(true);
    });

    it('String should be primitive', function () {
        expect(_.is.primitive('foo')).to.equal(true);
        expect(_.is.primitive(new String('foo'))).to.equal(true);
        expect(_.is.primitive(String('foo'))).to.equal(true);
        expect(_.is.primitive('')).to.equal(true);
    });

    it('Number should be primitive', function () {
        expect(_.is.primitive(42)).to.equal(true);
        expect(_.is.primitive(new Number(42))).to.equal(true);
        expect(_.is.primitive(Number(42))).to.equal(true);
        expect(_.is.primitive(0)).to.equal(true);
        expect(_.is.primitive(-0)).to.equal(true);
    });

    it('Null should be primitive', function () {
        expect(_.is.primitive(null)).to.equal(true);
    });

    it('Undefined should be primitive', function () {
        expect(_.is.primitive(undefined)).to.equal(true);
        expect(_.is.primitive()).to.equal(true);
    });
});

describe('_.is.type()', function () {
